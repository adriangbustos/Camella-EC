...
import { AuthGuard } from '../guardsUsuarios/auth.guard';
...
import { RedirectGuard } from '../guardsUsuarios/redirect.guard';
import { RecuperarContrasenaComponent } from './recuperar-contrasena/recuperar-contrasena.component';
import { OnboardingGuard } from '../guardsUsuarios/onboarding.guard';
import { OnboardingCompletedGuard } from '../guardsUsuarios/OnboardingCompleted.guard';
import { ReviewedGuard } from '../guardsUsuarios/reviewed.guard';
import { ReviewedCompletedGuard } from '../guardsUsuarios/reviewedCompletedGuard.guard';
...
export const userRoutes: Routes =  [
    ...
    { path: 'onboarding', component: OnboardingComponent, canActivate: [AuthGuard, OnboardingCompletedGuard] },
    {
        path: 'dashboard', component: TrabajadorConsumidorComponent, canActivate: [AuthGuard], children: [
            ...
            { path: 'offerts', component: OfertsComponent, canActivate: [OnboardingGuard] },
