...
export class SignUpComponent {
  ...
  constructor(private fb: FormBuilder, private authService: AuthServiceUsuarios, private router: Router
  ) {
  ...
  async submit() {
    if (this.signUpForm.valid) {
      ...
      try {
        ...
        await this.authService.createDocument('users', userCredential.uid, {
...
gotoLanding(){
  ...
  async navigateToProfile() {
      this.router.navigate(['/usuario/onboarding']); // Redirige a la página de onboarding si es false
  }
